...
public class MailkitEmailService : IEmailService
{
    ...
    public void SendVerificationEmail(string email, string token)
    {
        ...
        { 
            ...
            Content = $"Hi {email}, <br><br>There was a request to confirm your account!<br>If you did not make this request then please ignore this email!<br>Otherwise, please click this link to confirm",
            Receipents = new List<string>() { email }
        };
